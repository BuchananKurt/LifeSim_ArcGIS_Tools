        ...
        for alternative1 in alternative_names_list:
            ...
            for summarypolygonset in cleaned_list:
                ...
                for area in area_list:
                    ...
                    area_avgLL_day_query = f'SELECT SUM(Life_Loss_Total_Mean) FROM {results1_day_input} WHERE Max_Depth > 0 AND "Summary_Set_{areapolygon}" = ?'
                    ...
                    area_avgLL_night_query = f'SELECT SUM(Life_Loss_Total_Mean) FROM {results1_night_input} WHERE Max_Depth > 0 AND "Summary_Set_{areapolygon}" = ?'
