...
class Lifesim1(object):
    ...
    def execute(self, parameters, messages):
        ...
        for alternative1 in alternative_names_list:
            ...
            alt_to_sheet_map.append((alternative1, sanitized_sheet, hydscenario, haztime_formatted, epz_source))
            ...
            for epz in epz_list:
                ...
                result_df = convergence_by_ci(df_area,
                                        DEFAULT_LL_COLUMNS,
                                        conf_level, conv_tol, min_iters)
                ...
                if converged != True:
                        add_message(f"...POSSIBLE ISSUE - No convergence on {alternative1} - {epz}", lst=2)
                        add_message(f"...Final convergence error: {final_error_pct_round}", lst=2)
            ...
            for idx, message in enumerate(message_list2, start=1):
                ...
                if "POSSIBLE ISSUE" in message.upper().strip():
                    ...
                    add_message("See POSSIBLE ISSUE in Alt {0}:  {1}".format(alternative1, cleaned_message), lst=1)
        ...
        if alt_to_sheet_map:
            ...
            for i, (altname, sheetname, hydscenario, haztime_formatted, epz_source) in enumerate(alt_to_sheet_map, start=1):
