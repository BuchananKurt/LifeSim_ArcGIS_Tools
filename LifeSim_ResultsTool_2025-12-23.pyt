...
class Lifesim1(object):
    ...
    def execute(self, parameters, messages):
        ...
        for alternative1 in alternative_names_list:
            ...
            alt_to_sheet_map.append((alternative1, sanitized_sheet, hydscenario, haztime_formatted, epz_source, None))
            ...
            try:
                alt_to_sheet_map[-1] = (alternative1, sanitized_sheet, hydscenario, haztime_formatted, epz_source, bool(total_converged))
            except Exception:
        ...
        if alt_to_sheet_map:
            ...
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=mapping_start_row, column=6, value="Converge")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)

            for i, (altname, sheetname, hydscenario, haztime_formatted, epz_source, total_converged) in enumerate(alt_to_sheet_map, start=1):
                ...
                cell = ws.cell(row=mapping_start_row + i, column=6, value=total_converged)
