...
class Hdfplannames(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Get HDF Plan Names and Numbers"
        self.description = "Does lots of stuff."
        self.canRunInBackground = True
                        ...
                        if breach_data_table_key in hdf_file:
                            ...
                            for item in breach_data_name_values:
                                ...
                                if breaching_variable_table_key in hdf_file:
                                    ...
                                    cell.number_format = '#,##0.00'  # Set the desired number format
                                    ws.cell(row=1, column=start_col+4, value=f"Max Total Flow {brch_struc_number}")
                                    cell=ws.cell(row=currentrow, column=start_col+4, value=max_total_flow)
                                    cell.number_format = '#,##0'  # Set the desired number format
                                    ws.cell(row=1, column=start_col+5, value=f"Max Weir Flow {brch_struc_number}")
                                    cell=ws.cell(row=currentrow, column=start_col+5, value=max_weir_flow)
                                    cell.number_format = '#,##0'  # Set the desired number format
