...
class Lifesim1(object):
    ...
    def execute(self, parameters, messages):
        ...
        cell = ws.cell(row=row, column=col, value="Alternative")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+1, value="Structure #")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+2, value="PAR Day")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+3, value="PAR Night")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+4, value="LL Day")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+5, value="LL Night")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+6, value="Damage Total")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+8, value="LL Evac Day")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        cell = ws.cell(row=row, column=col+9, value="LL Evac Night")
        cell.alignment = Alignment(horizontal='center')
        cell.font = Font(bold=True)
        ...
        for alternative1 in alternative_names_list:
            ...
            if total_lifeloss_evac_day > 0 or total_lifeloss_evac_night > 0:
                cell = ws.cell(row=row, column=col+7, value="LL Evac Day")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+8, value="LL Evac Night")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
            # excel Increment row for EPZ after the column headings
            ...
            cell = ws.cell(row=current_row_total, column=col, value="Arrival Zone")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+1, value="Structure #")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+2, value="PAR Day")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+3, value="PAR Night")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+4, value="LL Day")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+5, value="LL Night")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+6, value="Depth Range")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+7, value="Velocity Range")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+8, value="% Warned (Day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+9, value="% Mobilized (Day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=current_row_total, column=col+10, value="Fatality Rate (Day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            ...
            col = start_col_epz
            # Set column headers
            cell = ws.cell(row=row, column=col, value="EPZ Name")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+1, value="Structure #")
            cell.alignment = Alignment(horizontal='center')
            ...
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+6, value="Struc PreHaz")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+7, value="Struc PostHaz")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+8, value="PAR PreHaz (day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+9, value="PAR PostHaz (day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+10, value="LL PreHaz (day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+11, value="LL PostHaz (day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+12, value="% Warned")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+13, value="% Mobilized")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            cell = ws.cell(row=row, column=col+14, value="Fatality Rate (day)")
            cell.alignment = Alignment(horizontal='center')
            cell.font = Font(bold=True)
            ...
            for summarypolygonset in cleaned_list:
                ...
                cell = ws.cell(row=row, column=col, value="Area Name")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+1, value="Structure #")
                cell.alignment = Alignment(horizontal='center')
                ...
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+6, value="Arrival Range")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+7, value="Depth Range")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+8, value="Velocity Range")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+9, value="DxV Range")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+10, value="Collapsed >50pct")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+11, value="Fatality Rate Day")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+12, value="% Warned Day")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+13, value="% Mobilized Day")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+14, value="Struc PostHaz")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+15, value="Avg Arrival PostHaz (hrs)")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+16, value="Avg Flood Depth (ft)")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
                cell = ws.cell(row=row, column=col+17, value="Arrival at first flooded PostHaz (hrs)")
                cell.alignment = Alignment(horizontal='center')
                cell.font = Font(bold=True)
            ...
            for time_label, results_table, total_lifeloss in time_table_list:
                ...
                cell = ws.cell(row=top10_start_row, column=start_col_total, value=f"Top 10 Structures by Life Loss ({time_label})")
                cell.font = Font(bold=True)
                ...
                if top10_rows and len(top10_rows[0]) == 10:
                    headers = ["Rank", "FID", "Occupancy Type", "Number Stories", "EPZ", "Summary Area", "Collapsed", "PAR", "Max Depth", "Max Velocity", "Life Loss", "% of Total LL"]
                else:
                ...
                for i, rowvals in enumerate(top10_rows, start=1):
                    ...
                    # handle both schemas
                    if len(rowvals) == 10:
                        fid, occ, stories, epzname, summary_area, collapsed, total_par, depth, velocity, total_ll = rowvals
                        ...
                        cell.number_format = '#,##0.0'
                        ll_cell = ws.cell(row=out_row, column=start_col_total+10, value=total_ll)
                        ...
                        cell = ws.cell(row=out_row, column=start_col_total+11, value=pct)
                        cell.number_format = '0.0%'
                        if pct > 0.10:
