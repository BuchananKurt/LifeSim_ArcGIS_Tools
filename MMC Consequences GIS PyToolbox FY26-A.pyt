...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [Nsicreator, Bufferandsimplifypoly, Polygonstodoublewarning, Nsicreatorapi, Reclassifytozone, Rastertopolygon, Snaptoexclusionpoly, Batchdefineprojection, Incrementallifesimresults, Nldleveedownload, occtyptodamcat]
