...
class Nsicreator(object):
    ...
    def getParameterInfo(self):
        ...
        parameters = [inputstudyarea, workspace, inputuscounties, inputnsifolder, priceindex, outputname, addfianame, stripfields]
        return parameters
    ...
    def execute(self, parameters, messages):
        ...
        stripfields = parameters[7].value
