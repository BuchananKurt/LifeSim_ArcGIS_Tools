...
class Nsicreatorapi(object):
    ...
    def getParameterInfo(self):
        ...
        parameters = [inputstudyarea, workspace, inputuscounties, fipsfieldname, priceindex, outputname, addfianame, internalnsi, splitbypolygons, clearbuffer, reprojectoutput]
