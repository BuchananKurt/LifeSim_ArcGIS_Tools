...
class Polygonstodoublewarning(object):
    ...
    def getParameterInfo(self):
        ...
        parameters = [inputstudyarea, inputinpoolpolygon, inputnonbreach1, epzfolder, scenario1name, inputnonbreach2, scenario2name, dissolvestudyarea, studyareanamefield, info_text]
        return parameters
